...
def udf(bbox: fused.types.Tile=None):
    ...
    zonal_stats_utils = fused.load("https://github.com/fusedio/udfs/tree/ee9bec5/community/plinio/Zonal_Stats_Forest_Obs/").utils # Load pinned versions of utility functions.
    ...
    gdf_bounds = zonal_stats_utils.get_asset_dissolve(s3_file_path)
