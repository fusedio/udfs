...
def udf(
    ...
    gdf_cells = zonal_utils.get_asset_dissolve(url=table_tif_bounds)
    ...
    geom_bounds_muni = utils.geo_bounds(gdf_muni).geometry[0]
    ...
    df_pre_final = zonal_utils.zonal_stats_df(gdf_muni=gdf_muni, da=da, tiff_url=tiff_url, stats_dict=stats_dict)
