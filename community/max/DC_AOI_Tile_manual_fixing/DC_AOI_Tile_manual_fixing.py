...
def udf(bounds: fused.types.Bounds=[-77.083,38.849,-76.969,38.938], time_of_interest="2021-09-01/2021-12-30", chip_len:int=512, scale:float=0.1):
    ...
    tile = common_utils.get_tiles(bounds, target_num_tiles = 4, clip=True)
    ...
    arr = udf_sentinel.utils.get_arr(tile[:30], time_of_interest=time_of_interest, output_shape=(chip_len, chip_len))
