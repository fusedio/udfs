...
@fused.udf
def udf(meta_url='https://s3.us-west-2.amazonaws.com/umbra-open-data-catalog/stac/2023/2023-04/2023-04-30/657068a8-6237-452d-bfdc-d535df37900b/657068a8-6237-452d-bfdc-d535df37900b.json',
    ...
    bounds = gpd.GeoDataFrame(geometry=[shapely.box(*bbox)],crs='32618').to_crs(4326).buffer(-0.0005).total_bounds
