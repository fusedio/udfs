@fused.udf
def udf(bbox, census_variable='Total Pop', scale_factor=200, is_density=True, year=2022):
    ...
    #read the variables
    gdf=acs_5yr_bbox(bbox.total_bounds, census_variable=census_variable, suffix=suffix, year=year)
    if len(gdf)==0:
        return None
