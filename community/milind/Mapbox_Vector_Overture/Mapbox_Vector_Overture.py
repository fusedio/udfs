...
def udf(
    ...
    # -------------------------------------------------------------------------
    # HTML / JS template (Jinja2). Curly braces that belong to Jinja2 are {{ … }},
    # those needed inside JS string literals are escaped by doubling {{}} only
    # when they are literal empty {} objects.
    # -------------------------------------------------------------------------
    html = Template(r"""
<!DOCTYPE html>
<html>
