...
def udf(
    ...
    layer : str
        Name of the data layer to visualize (default ``'cnc_dust'``).
    min_max : tuple
        Minimum and maximum values for color scaling.
    year, month, day : int
        Date components for the initial time slice.
    step : int
        Index of the time step to select. 1 step is one hour

    Returns
    -------
    viz : object
        Visualization object generated by ``common_utils.visualize``.
    """
    ...
    # Assuming your main variable is called "variable_name"
    arr = z["cnc_dust"]
