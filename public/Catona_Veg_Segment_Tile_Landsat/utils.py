...
def process_image(bands_tuple, zoom_level, index_min:float = 0.1, index_max:float=1.0, vegetation_index: str = "VARI"):
   
    # Get the bands of the image
    blue, green, red, rgb = bands_tuple# get_bands(image_path)
