DEFAULT_CONFIG = r"""{\"tileLayer\":{\"@@type\":\"TileLayer\",\"maxZoom\":12},\"hexLayer\":{\"@@type\":\"H3HexagonLayer\",\"filled\":true,\"pickable\":true,\"extruded\":true,\"getHexagon\":\"@@=properties.hex\",\"getElevation\":{\"@@function\":\"hasProp\",\"property\":\"acc_cnt\",\"present\":\"@@=properties.acc_cnt*properties.acc_cnt\",\"absent\":1},\"elevationScale\":1,\"getFillColor\":{\"@@function\":\"colorContinuous\",\"attr\":\"acc_cnt\",\"domain\":[5000,0],\"steps\":20,\"colors\":\"Magenta\"}}}"""

@fused.udf(cache_max_age=0)
def udf(
    tile_url_template: str = "https://udf.ai/UDF_JP_intersection_accidents/run/tiles/{z}/{x}/{y}?dtype_out_vector=json",
    config_json: str = DEFAULT_CONFIG,
    mapbox_token: str = "pk.eyJ1IjoiaXNhYWNmdXNlZGxhYnMiLCJhIjoiY2xicGdwdHljMHQ1bzN4cWhtNThvbzdqcSJ9.73fb6zHMeO_c8eAXpZVNrA",
    center_lng: float = 139.6917,
